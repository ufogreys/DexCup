...
To make the interface work with your Moonbase Alpha deployment, you need to modify the `./src/pcs_address.json`. Also make sure that you modify the addresses in the SDK repo.
